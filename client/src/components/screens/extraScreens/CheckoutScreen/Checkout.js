 ...
 useEffect(() => {
  const fetchCart = async () => {
    try {
      ...
      console.log('Cart of specific shop:', shopCart);
      ...
      if (shopCart?.products && typeof shopCart.products === 'object') {
        ...
        setProductSummary(summary); // ✅ Store in state
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
        <View style={styles.container}>
          ...
          <View style={styles.paymentContainer}>
            ...
            {errors.selectedPayment && selectedPayment !== 'wallet' && <Text style={styles.error}>{errors.selectedPayment}</Text>}
